...
def main(args):
    ...
    save_model_path = os.path.join(args.save_model_path, 'gamma_model_file')
    ...
    for epoch in range(args.epochs):
        ...
        for split in splits:
            ...
            for iteration, batch in enumerate(data_loader):
                ...
                if args.C_max != 0 and args.gamma != 0:
                    C = min(args.C_max, args.C_max / args.C_stop * epoch)
                    loss = (NLL_loss + abs(args.gamma * (KL_loss - C))) / batch_size
                else:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default='trump_data')
    ...
    parser.add_argument('-x0', '--x0', type=int, default=1750)
    ...
    #beta 
    parser.add_argument('-gamma', '--gamma', type=int, default=10)
    parser.add_argument('-C_max', '--C_max', type=int, default=50)
    parser.add_argument('-C_stop', '--C_stop', type=int, default=2600)
